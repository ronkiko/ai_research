...
class DealerMechanics(Mechanics):
    ...
    RULES = (
        ...
        "  Вопрос: какой должна быть ставка?\n"
        "  Правда: ставка отличается от карты дилера.\n"
        "  Это инверсия предсказания: выигрывает не тот, кто угадал карту, "
        "а тот, кто поставил против неё."
    )
    LEARNS = (
