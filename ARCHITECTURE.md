...
навигации и обучения через MCP. Этап 02 уже зафиксировал новые identity/action/world
contracts и map catalog в `world/`, но authority ещё не переключён: описание
действующего разделения VN/физического стенда ниже остаётся верным до следующих
этапов. Перенос authority выполняется поэтапно.
