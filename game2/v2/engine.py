"""Authoritative V2 world service and its process entrypoint.
...
from game2.v2.world.physics import PhysicsConfig, PhysicsWorld
from game2.v2.world.state import AvatarState, TelemetrySnapshot, WorldState
...
class EngineService:
    ...
    def run(self) -> dict:
        ...
        try:
            ...
            # Keep CONTROL open until SUMMARY exists so Router can distinguish a
