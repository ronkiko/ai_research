"""Convert public logical Vision grids into CNN channels."""
...
PHYSICS_CHANNELS = 3
METADATA_CHANNEL_BITS = (META_SELF, META_GOAL, META_OTHER_ACTOR)
VISION_CHANNELS = PHYSICS_CHANNELS + len(METADATA_CHANNEL_BITS)


def vision_to_tensor(grid: VisionGrid) -> torch.Tensor:
    """Return one VisionGrid as float32 [EMPTY,SOLID,HAZARD,SELF,GOAL,OTHER]."""
