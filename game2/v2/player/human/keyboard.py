"""Keyboard state adapter and standalone Pygame window for the Human Player."""
...
class HumanKeyboardInput:
    """Event-fed keyboard state adapter with no Pygame window ownership."""
...
class KeyboardWindow:
    ...
    def __init__(self, pygame_module=None):
        ...
        self.input = HumanKeyboardInput(pygame_module)
        self.closed = False
...
__all__ = ["HumanKeyboardInput", "KeyboardState", "KeyboardWindow",
