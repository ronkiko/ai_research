...
Разные модели ИИ выполняют функции разных человеческих подсистем, работают на
разных частотах, получают различную информацию, спорят, обучаются на
последствиях и влияют друг на друга. Целостное человекоподобное поведение должно
возникать из их совместной истории, а не из таблицы заранее заданных реакций.

Brain LLM отвечает за медленное смысловое мышление и социальное понимание,
Spine CNN — за быстрое восприятие и координацию, Motor MLP — за рефлекторное
управление. Эмоциональное желание, целостность границ и другие будущие
психические функции также рассматриваются как самостоятельные модели с
собственным состоянием, а не как формулы вида `if trust > N`.
