...
План следующего рефакторинга: [единое тело Юки в мире новеллы — 10 коммитов](docs/refactor/embodied-vn/01-concept.md).
Он задаёт новую целевую архитектуру; её реализация ещё не выполнена.
