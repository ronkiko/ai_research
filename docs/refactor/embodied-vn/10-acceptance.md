# 10 / 10 — Повторный аудит исходной цели и окончательная приёмка

Зависимость: выполненные 02–09. Коммит: `Audit and accept the unified embodied VN`.
...
Заново прочитать [01-concept.md](01-concept.md) целиком, затем все остальные
девять документов, актуальные root/local AGENTS, архитектуру и код реализации.
...
решения Директора; запрещено ослаблять A1–A10 ради зелёной приёмки.
...
| A2: обученное движение | Policy hashes и trace CNN/Motor → Host; отсутствие steering fallback в коде |
...
версии/профили, матрица A1–A10, команды и результаты, artifact IDs/hashes,
...
Серия принята, только если обязательные сценарии пройдены и каждый A1–A10 имеет
...
суставную посадку или долговременную пластичность личности: они вне этой серии.
