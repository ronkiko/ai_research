...
Место новеллы в организме, отдельные часы и план развития памяти описаны в
[общем контракте](../ARCHITECTURE.md). Shell означает тонкий браузерный интерфейс;
движок состояния и оркестрации реализован на Python.
