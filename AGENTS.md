...
- **GameTable tasks:** read `gametable/AGENTS.md` and `gametable/DESK.md`; the Director supplies the assignment in conversation. The assistant operates the game and laboratory through the two local MCP manuals, not by entering neighboring project directories.
